...
import io.github.cmartell22.scoutremastered.PackMenu;
import io.github.cmartell22.scoutremastered.PackMenuData;
import io.github.cmartell22.scoutremastered.PackMenuLayout;
...
public final class PackScreen extends AbstractContainerScreen<PackMenu> {
	...
	private static final Component SATCHEL = Component.translatable("container.scoutremastered.satchel");
	private static final Component LEFT_POUCH = Component.translatable("container.scoutremastered.left_pouch");
	private static final Component RIGHT_POUCH = Component.translatable("container.scoutremastered.right_pouch");
	...
	public Component getNarrationMessage() {
		...
		return Component.translatable(
			"narration.scoutremastered.pack",
			this.title,
	...
	private static Component capacityNarration(int capacity) {
		return capacity > 0
			? Component.translatable("narration.scoutremastered.slot_count", capacity)
			: Component.translatable("narration.scoutremastered.not_equipped");
	}
}
