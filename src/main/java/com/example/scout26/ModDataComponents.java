...
/**
 * Scout26 data component registrations.
 */
public final class ModDataComponents {
	public static final DataComponentType<BagContents> BAG_CONTENTS = Registry.register(
		BuiltInRegistries.DATA_COMPONENT_TYPE,
		Identifier.fromNamespaceAndPath(Scout26Mod.MOD_ID, "bag_contents"),
	...
	public static void initialize() {
		Scout26Mod.LOGGER.debug("Scout26 data components registered");
	}
}
